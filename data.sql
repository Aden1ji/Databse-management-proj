...
INSERT INTO Charger (station_id, connector_type, charging_speed_kw, status) VALUES
                                                                                ...
                                                                                (6, 'CCS', 50.0, 'Available');

-- 5. Reservation (depends on Users + Charger)
...
-- 6. ChargingSession (depends on Reservation)
